...
typedef enum {
    ...
    MICROINJECTOR_FUNCTION_HOOK_NO_VALID_TYPE = 4,
    MICROINJECTOR_FUNCTION_HOOK_TRAMPOLINE_ALLOCATION_FAILURE = 5,
    MICROINJECTOR_FUNCTION_HOOK_TRAMPOLINE_PROTECT_FAILURE = 6,
    MICROINJECTOR_FUNCTION_HOOK_PAGE_ALLOCATION_FAILURE = 7,
